...
public class GoogleLoginActivity extends Activity implements IHttpReceive, Handler.Callback,
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        KLog.d(this.getClass().getSimpleName(), "onActivityResult:" + requestCode + ":" + resultCode + ":" + data);
    ...
    public void onConnected(Bundle bundle) {
        KLog.d(this.getClass().getSimpleName(), "@@ onConnected:" + bundle);
        ...
        if (accountName != null) {
            KLog.d(this.getClass().getSimpleName(), "@@ accountName:" + accountName);
        ...
        if (isValue != null && isValue.equals("Y")) {
            KLog.d(this.getClass().getSimpleName(), "@@ 구글 액티비티 로그아웃 시작 ");
            requestLogout();
    ...
    public void onConnectionSuspended(int i) {
        KLog.d(this.getClass().getSimpleName(), "@@ onConnectionSuspended:" + i);
    ...
    public void onConnectionFailed(ConnectionResult result) {
        KLog.d(this.getClass().getSimpleName(), "@@ onConnectionFailed:" + result.toString());
...
//                        String scopes = "audience:server:client_id:" + ConstUtils.KEY_GOOGLE_CLIENT_ID+":api_scope:https://www.googleapis.com/auth/plus.login"; // Not the app's client ID.
                        ...
                        try {
                            KLog.d(this.getClass().getSimpleName(), "@@ getApplicationContext : " + getApplicationContext());
                            KLog.d(this.getClass().getSimpleName(), "@@ accountName : " + accountName);
                            KLog.d(this.getClass().getSimpleName(), "@@ scopes : " + mScope);

                            token = GoogleAuthUtil.getToken(getApplicationContext(), accountName, mScope);

                        } catch (IOException e) {
                            KLog.d(this.getClass().getSimpleName(), "@@ Error retrieving ID token. 1");
                            return null;
                        } catch (GoogleAuthException e) {
                            KLog.d(this.getClass().getSimpleName(), "@@ Error retrieving ID token. 2");
                            return null;
                        }
                        KLog.d(this.getClass().getSimpleName(), "@@ token : " + token);
                    ...
                    protected void onPostExecute(String token) {
                        KLog.d(this.getClass().getSimpleName(), "Access token retrieved:" + token);
            ...
            case REQUEST_TOKEN_INFO://토큰 정보
                ...
                KLog.d(this.getClass().getSimpleName(), " 구글 정보 가져오기");
                break;
            case LOGOUT://로그아웃
//                sqlQuery.deleteUserLogin(mContext);
...
//                mLoginData.setSNS(ContextUtils.KEY_LOGIN_GOOGLE);
    ...
    private void requestLogout() {
        KLog.d(this.getClass().getSimpleName(), "@@ 구글 로그아웃 요청 : " + mGoogleApiClient.getContext());
        ...
        if (mGoogleApiClient.isConnected()) {
            ...
            Plus.AccountApi.revokeAccessAndDisconnect(mGoogleApiClient).setResultCallback(new ResultCallback<Status>() {
                ...
                public void onResult(Status status) {
                    KLog.d(this.getClass().getSimpleName(), "@@ user aceesss revoked !!!");
                    mGoogleApiClient.disconnect();
