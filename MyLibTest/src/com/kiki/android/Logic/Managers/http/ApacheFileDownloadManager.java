...
public class ApacheFileDownloadManager extends AsyncTask<Object, Void, Void> {
    ...
    protected Void doInBackground(Object... params) {
        ...
        Log.d(com.kiki.android.Utils.conf.Log.LOG_NAME, "@@ url : " + mUrl);
        ...
        try {
            ...
            Log.d(com.kiki.android.Utils.conf.Log.LOG_NAME, this.getClass() + " @@ saveFile : " + saveFileName);
            Log.d(com.kiki.android.Utils.conf.Log.LOG_NAME, this.getClass() + " @@ saveFile  path: " + path.getPath() + "/" + saveFileName);
