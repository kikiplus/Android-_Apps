...
public class HttpUrlFileDownloadManager extends AsyncTask<Object, Void, Void> {
    ...
    protected Void doInBackground(Object... params) {
        ...
        try {
            ...
            Log.d(com.kiki.android.Utils.conf.Log.LOG_NAME, "@@ saveFile : " + saveFile);
            Log.d(com.kiki.android.Utils.conf.Log.LOG_NAME, "@@ saveFile  path: " + path.getPath() + "/" + saveFile);
            ...
            if (input != null) {
                while ((count = input.read(data)) != -1) {
                    total += count;
                    Log.d(com.kiki.android.Utils.conf.Log.LOG_NAME, "@@ data loading = " + (int) total);
