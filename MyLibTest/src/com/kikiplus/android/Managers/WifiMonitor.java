package com.kikiplus.android.Managers;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (strAction.equals(WifiManager.NETWORK_STATE_CHANGED_ACTION)) {
            if (networkInfo.getState() == NetworkInfo.State.CONNECTED) {
                ...
                KLog.d(this.getClass().getSimpleName(),  this.getClass() + " onReceive  : 111111111 " );
                mIWiFiStatusListener.OnChangedStatus(mIWiFiStatusListener.NETWORK_STATE_DISCONNECTED, null);
            } else if(networkInfo.getState() == NetworkInfo.State.SUSPENDED) {
                KLog.d(this.getClass().getSimpleName(),  this.getClass() + " onReceive  : 111111111 222222222" );
                mIWiFiStatusListener.OnChangedStatus(mIWiFiStatusListener.NETWORK_STATE_DISCONNECTED, null);
            }
        }else if(strAction.equals(ConnectivityManager.CONNECTIVITY_ACTION)){
            KLog.d(this.getClass().getSimpleName(),  this.getClass() + " onReceive  :  " + intent.getStringExtra(ConnectivityManager.EXTRA_EXTRA_INFO));
        }
    }
}
