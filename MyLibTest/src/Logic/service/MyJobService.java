...
public class MyJobService extends JobService {
    ...
    public boolean onStartJob(JobParameters params) {
        Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + " @@ onStartJob ");
    ...
    private static class JobServiceTask extends AsyncTask<JobParameters, Void, JobParameters> {
        ...
        protected JobParameters doInBackground(JobParameters... params) {
            Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + " @@ doInBackground no");
        ...
        protected void onPostExecute(JobParameters jobParameters) {
            if (Build.VERSION.SDK_INT > 21) {
                Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + " @@  onPostExecute");
                        myJobService.jobFinished(jobParameters, false);
            }else{
                Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + " @@  onPostExecute no");
            }
        }
    }
}
