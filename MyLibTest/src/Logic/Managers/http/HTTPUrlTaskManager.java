...
public class HttpUrlTaskManager extends AsyncTask<String, Void, Void> {
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + "MalformedURLException");
        } catch (ProtocolException e) {
            e.printStackTrace();
            Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + "ProtocolException");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
            Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + "UnsupportedEncodingException");
        } catch (IOException e) {
            e.printStackTrace();
