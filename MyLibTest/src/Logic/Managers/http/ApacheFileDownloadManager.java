...
public class ApacheFileDownloadManager extends AsyncTask<Object, Void, Void> {
    ...
    protected Void doInBackground(Object... params) {
        ...
        Log.d(Utils.conf.Log.LOG_NAME, "@@ url : " + mUrl);
        ...
        try {
            ...
            Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + " @@ saveFile : " + saveFileName);
            Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + " @@ saveFile  path: " + path.getPath() + "/" + saveFileName);
