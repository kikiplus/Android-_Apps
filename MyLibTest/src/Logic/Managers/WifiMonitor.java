...
import Listener.Listerner.IWiFiStatusListener;
...
public class WifiMonitor extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + " onReceive action :  " + strAction);
        ...
        if (strAction.equals(WifiManager.NETWORK_STATE_CHANGED_ACTION)) {
            if (networkInfo.getState() == NetworkInfo.State.CONNECTED) {
                ...
                Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + " onReceive  : 111111111 " );
                mIWiFiStatusListener.OnChangedStatus(mIWiFiStatusListener.NETWORK_STATE_DISCONNECTED, null);
            } else if(networkInfo.getState() == NetworkInfo.State.SUSPENDED) {
                Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + " onReceive  : 111111111 222222222" );
                mIWiFiStatusListener.OnChangedStatus(mIWiFiStatusListener.NETWORK_STATE_DISCONNECTED, null);
            }
        }else if(strAction.equals(ConnectivityManager.CONNECTIVITY_ACTION)){
            Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + " onReceive  :  " + intent.getStringExtra(ConnectivityManager.EXTRA_EXTRA_INFO));
        }
    }
}
