...
import Bean.WiFiAP;
import Interface.IWiFiScanLinstener;
...
public class WifiMgr {
    ...
    public void startScan() {
        if (Build.VERSION.SDK_INT >= 18) {
            ...
            if (mWifiManger.isScanAlwaysAvailable()) {
                ...
                Log.d(conf.Log.LOG_NAME, this.getClass() + " startScan");
                return;
            }
        }
    ...
    public void stopScan() {
        ...
        Log.d(conf.Log.LOG_NAME, this.getClass() + " stopScan");
    }
    ...
    private BroadcastReceiver mWifiReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(WifiManager.SCAN_RESULTS_AVAILABLE_ACTION)) {
                Log.d(conf.Log.LOG_NAME, this.getClass() + " wifiReciever ");
    ...
    public boolean connectAp(WiFiAP ap, String pass) {
        Log.d(conf.Log.LOG_NAME, this.getClass() + " connectAp ");
        Log.d(conf.Log.LOG_NAME, this.getClass() + " ssid :  " + ap.getSSID());
        Log.d(conf.Log.LOG_NAME, this.getClass() + " bssid :  " + ap.getMac());
        Log.d(conf.Log.LOG_NAME, this.getClass() + " getCapability :  " + ap.getCapability());
        Log.d(conf.Log.LOG_NAME, this.getClass() + " getDecibel :  " + ap.getDecibel());
        Log.d(conf.Log.LOG_NAME, this.getClass() + " pass :  " + pass);
