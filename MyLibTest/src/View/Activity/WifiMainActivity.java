...
import Logic.Managers.WifiMgr;
import Logic.Managers.WifiMonitor;
import View.UIComfonent.EditDialog;
import View.UIComfonent.ProgressBar;
import View.ViewAdapter.WifiListAdpater;
...
public class WifiMainActivity extends Activity implements IWiFiScanLinstener, View.OnClickListener, Handler.Callback, OnButtonSelectedListener, IWiFiStatusListener {
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            case 0:// wifi 결과 표시
                Log.d(Utils.conf.Log.LOG_NAME, this.getClass() + " handleMessage ");
