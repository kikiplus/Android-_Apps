...
import Bean.WiFiAP;
import Event.OnButtonSelectedListener;
import Interface.IWiFiScanLinstener;
import Interface.IWiFiStatusListener;
import Managers.WifiMgr;
import Managers.WifiMonitor;
import UIComfonent.EditDialog;
import UIComfonent.ProgressBar;
import ViewAdapter.WifiListAdpater;
...
public class WifiMainActivity extends Activity implements IWiFiScanLinstener, View.OnClickListener, Handler.Callback, OnButtonSelectedListener, IWiFiStatusListener {
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            case 0:// wifi 결과 표시
                Log.d(conf.Log.LOG_NAME, this.getClass() + " handleMessage ");
